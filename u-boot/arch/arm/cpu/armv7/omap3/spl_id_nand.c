...
void identify_nand_chip(int *mfr, int *id)
{
	...
	writel(DEFAULT_NAND_GPMC_CONFIG1, &gpmc_config->cs[0].config1);
	writel(DEFAULT_NAND_GPMC_CONFIG2, &gpmc_config->cs[0].config2);
	writel(DEFAULT_NAND_GPMC_CONFIG3, &gpmc_config->cs[0].config3);
	writel(DEFAULT_NAND_GPMC_CONFIG4, &gpmc_config->cs[0].config4);
	writel(DEFAULT_NAND_GPMC_CONFIG5, &gpmc_config->cs[0].config5);
	writel(DEFAULT_NAND_GPMC_CONFIG6, &gpmc_config->cs[0].config6);
